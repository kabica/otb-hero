...
const heroStyles = {
  ...
  badge: 'inline-flex items-center gap-2 text-orange-600 font-medium tracking-widest',
  ...
  playBtn: 'flex items-center gap-3 text-orange-600 hover:text-orange-700 transition',
